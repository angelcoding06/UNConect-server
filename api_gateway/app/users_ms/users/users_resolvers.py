...
def create_friend_request(senderId:str, receiverId:str)-> FriendRequestClass:
	try:
...
def accept_friend_request(senderId:str, receiverId:str)-> str:
	try:
...
def reject_friend_request(senderId:str, receiverId:str)-> str:
	try:
...
def delete_friendship(friendshipId:str)-> str:
	try:
...
def get_friends_ids(userId:str)->FriendsArray :
	try:
