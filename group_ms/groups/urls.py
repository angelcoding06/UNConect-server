...
urlpatterns=[
    ...
    path('putGroup/<int:group_id>/', putGroup),
    path('deleteGroup/<int:group_id>/', deleteGroup),
    path('get_members/<int:group_id>/', get_members),
    path('add_member/<int:group_id>/', add_member),
    path('get_in_request/<int:group_id>/', get_in_request),
    path('add_in_request/<int:group_id>/', add_in_request),
    ...
    path('add_admin/<int:group_id>/', add_admin),
